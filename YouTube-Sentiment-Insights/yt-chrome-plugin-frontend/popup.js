...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyABfX7vDt3i4bUhC9xDWyx6CR-fA65kOw8';  // Replace with your actual YouTube Data API key
  ...
  async function getSentimentPredictions(comments) {
    try {
      console.log("Sending comments to API:", comments);
      ...
      outputDiv.innerHTML += `<p>Error details: ${error.message}</p>`;
      return null;
    }
  }
